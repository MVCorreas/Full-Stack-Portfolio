      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="lg:col-span-7 place-self-center text-center sm:text-left">
          <h1 className="text-black mb-4 text-4xl lg:text-6xl font-extrabold">
            <div className="text-transparent bg-clip-text bg-gradient-to-r from-[#a8dadc] via-[#457b9d] to-[#1d3557]">
              {" "}
              Hello, I&apos;m{" "}
            </div>
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="flex container lg:py-4 flex-wrap items-center justify-center">
              ...
              >
                <button className="px-3 py-3 mb-2 rounded-full w-full sm:w-fit mr-4 bg-gradient-to-br from-[#a8dadc] via-[#457b9d] to-[#1d3557] hover:bg-slate-200 text-white ">
                  Hire Me
                </button>
              </Link>
              <Link
                href={
                  "https://drive.google.com/file/d/17goJSipywsJ8qeJW3W7njhCttsClflI9/view?usp=sharing"
                }
              >
