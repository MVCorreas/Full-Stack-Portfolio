    ...
    >
      <div className="z-10">
        ...
        <p className="text-black mb-4 max-w-md">
          {" "}
          I&apos;m currently looking for new opportunities. You can contact me
          for further information. I&apos;ll get back to you asap.
        </p>
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/MVCorreas" className="color-[#1d3557]">
            <Image
              src="/github-icon.svg"
              alt="Github Icon"
              width={60}
